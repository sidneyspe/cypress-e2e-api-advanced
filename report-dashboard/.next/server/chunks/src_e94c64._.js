...
async function GET(request) {
    try {
        ...
        // Build conditions
        const conditions = [];
        if (squad?.length) conditions.push((0, __TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["inArray"])(__TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__schema$3e$__["schema"].executions.squad, squad));
        ...
        }).from(__TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__schema$3e$__["schema"].executions).where(whereClause);
        const total = countResult[0]?.count || 0;
        // Get paginated results
        const results = await __TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__schema$3e$__["schema"].executions).where(whereClause).orderBy((0, __TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$select$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["desc"])(__TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__schema$3e$__["schema"].executions.dateKey), (0, __TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$select$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["desc"])(__TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__schema$3e$__["schema"].executions.id)).limit(pageSize).offset((page - 1) * pageSize);
...
async function POST(request) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$report$2d$dashboard$2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__schema$3e$__["schema"].executions).values({
            date: body.date,
...
//# sourceMappingURL=src_e94c64._.js.map